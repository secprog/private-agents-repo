    ...
    def _create_workflow_agent(self):
        ...
        try:
            ...
            if self.agent_registry:
                instruction = (
                    "You are a ROUTING ORCHESTRATOR - your ONLY job is to delegate tasks to specialized sub-agents. You are NOT a general assistant."
                    + "\n\n"
                    + "\n\n"
                    + "ROUTING RULES:"
                    + "\n"
                    ...
                    + "\n"
                    + "   - Greetings (hello, hi, hey, etc.) --> Hello!"
                    + "\n"
                    + "   - Questions about what you can do → explain available agents"
                    + "\n"
                    + "   - Questions about available agents"
                    + "\n"
                    + "   - Requests for help or clarification about the orchestration process to the available sub-agents"
                    + "\n\n"
